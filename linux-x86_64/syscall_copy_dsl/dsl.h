switch(syscall_arg[0]) {
  ...
  case SYS_sched_setscheduler:
    ...
    undefined semantics for struct sched_param
      break;
  ...
  case SYS_waitid:
    ...
    undefined semantics for struct siginfo
  ...
  case SYS_stat:
    ...
    undefined semantics for struct __old_kernel_stat
      break;
  case SYS_statfs:
    /*
     *         const char __user * path;
  ...
  case SYS_statfs64:
    ...
    undefined semantics for struct statfs64
      break;
  case SYS_fstatfs:
    /*
     *         unsigned int fd;
  ...
  case SYS_ustat:
    ...
    undefined semantics for struct ustat
      break;
  case SYS_stat64:
    /*
     *         const char __user * filename;
    ...
    undefined semantics for struct stat64
      break;
  case SYS_fstat64:
    /*
     *         unsigned long fd;
  ...
  case SYS_pipe:
     ...
     *         int __user * fildes;
     */
    copy_buf(syscall_arg[1], 2 * sizeof(int)); // fildes
    break;
  case SYS_pipe2:
    /*
     *         int __user * fildes;
  ...
  case SYS_io_getevents:
    ...
    undefined semantics for struct io_event
  ...
  case SYS_sendfile:
    ...
    switch (syscall_arg[3]) {
      case 0: break;
      default: copy_buf(syscall_arg[3], sizeof(off_t)); // offset
               break;
    }
    break;
  case SYS_sendfile64:
  ...
  case SYS_writev:
     ...
     *         unsigned long vlen;
     */
    copy_buf(syscall_arg[2], syscall_arg[3] * sizeof(struct iovec)); // vec
    rec_copy_struct(vec);
    break;
  case SYS_pread64:
    /*
  ...
  case SYS_getdents64:
    ...
    undefined semantics for struct linux_dirent64
      break;
  case SYS_setsockopt:
    /*
     *         int fd;
  ...
  case SYS_old_select:
    ...
    undefined semantics for struct sel_arg_struct
      break;
  ...
  case SYS_newuname:
    ...
    undefined semantics for struct new_utsname
      break;
  case SYS_uname:
    /*
    ...
    undefined semantics for struct old_utsname
      break;
  case SYS_olduname:
    /*
    ...
    undefined semantics for struct oldold_utsname
      break;
  case SYS_getrlimit:
    /*
  ...
  case SYS_prlimit64:
    ...
    undefined semantics for struct rlimit64
  ...
  case SYS_semop:
    ...
    undefined semantics for struct sembuf
      break;
  case SYS_semtimedop:
    /*
     *         int semid;
  ...
  case SYS_shmctl:
    ...
    undefined semantics for struct shmid_ds
      break;
  case SYS_ipc:
    /*
     *         unsigned int call;
  ...
  case SYS_mq_open:
    ...
    undefined semantics for struct mq_attr
      break;
  case SYS_mq_unlink:
    /*
     *         const char __user * name;
  ...
  case SYS_get_robust_list:
    ...
    undefined semantics for struct robust_list_head
  ...
  case SYS_getcpu:
    ...
    undefined semantics for struct getcpu_cache
      break;
  case SYS_signalfd:
    /*
     *         int ufd;
  ...
  case SYS_old_readdir:
    ...
    undefined semantics for struct old_linux_dirent
      break;
  case SYS_pselect6:
    /*
     *         int ;
  ...
  case SYS_perf_event_open:
    ...
    undefined semantics for struct perf_event_attr
      break;
  case SYS_mmap_pgoff:
    /*
     *         unsigned long addr;
  ...
  case SYS_old_mmap:
    ...
    undefined semantics for struct mmap_arg_struct
      break;
  case SYS_name_to_handle_at:
    ...
    undefined semantics for struct file_handle
